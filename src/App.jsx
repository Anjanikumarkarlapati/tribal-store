...
import TribalAdminDashboard  from './pages/dashboards/TribalAdminDashboard';
import HeritageDashboard     from './pages/dashboards/HeritageDashboard';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/dashboard/tribal-admin"  element={<PrivateRoute allowedRole="admin"><TribalAdminDashboard /></PrivateRoute>} />
        <Route path="/dashboard/heritage"      element={<PrivateRoute><HeritageDashboard /></PrivateRoute>} />
