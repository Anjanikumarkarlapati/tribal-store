...
export default function Artisans() {
  ...
  return (
    <div style={{paddingTop:'72px'}}>
      <div style={{textAlign:'center',padding:'5rem 2rem 3rem',background:'linear-gradient(rgba(28,16,8,0.8), rgba(28,16,8,0.8)), url(https://images.unsplash.com/photo-1544965850-6f816af7cebc?auto=format&fit=crop&q=80) center/cover no-repeat'}}>
